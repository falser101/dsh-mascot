	...
	factory: (require) => {
		...
		*/
		function MascotView(props) {
			...
			const bubbleText = state.collapsed ? t("collapse.hint") : poke?.text ?? t(hovering ? hoverKeyOf(mascot.mood, idleHoverIndex) : mascot.textKey, mascot.params);
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)("span", {
						...
						children: bubbleText
					}, bubbleText), busyMarked && (0, react_jsx_runtime.jsxs)("span", {
		...
		*/
		...
		//#endregion
		//#region lib/types/client/BubbleSettingRow.js
		/**
